...
<body>
    ...
    <table id="customers">
        <tr>
            <td>
                <h2>
                    <?php $image_path = '/upload/liberty-logo.png'; ?>
    ...
    @php
        $registrationfee = App\Models\FeeCategoryAmount::where('fee_category_id', '10')
